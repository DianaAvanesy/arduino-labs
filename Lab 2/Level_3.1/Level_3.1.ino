/*
            ...
            Title: The program flashes my personal light show    
...
int waitTime0 = 4000; //Sets the amount of time to wait between color changes.
int waitTime01 = 4500;
...
// First 4 sec of song - red light 

        //Display Red
          digitalWrite(RGBRedPin, HIGH); //Turn on RED
          delay(waitTime0);               //Wait for 2 seconds
          digitalWrite(RGBRedPin, LOW);  //Turn off Red

// 4 - 8 sec of song - blue light 

          //Display Blue
          digitalWrite(RGBBluePin, HIGH); //Turn on RED
          delay(waitTime01);               //Wait for 2 seconds
...
digitalWrite(RGBBluePin, LOW); //Turn on RED
  ...
  //Display  Cyan  (Blue + Green) 
          ...
          delay(waitTime);               //Wait for 2 seconds
          digitalWrite(RGBRedPin, LOW);  //Turn off Red
          digitalWrite(RGBGreenPin, LOW); //Turn of RED//Display Green
         digitalWrite(RGBGreenPin, HIGH); //Turn on RED
         delay(waitTime);               //Wait for 2 seconds
         digitalWrite(RGBGreenPin, LOW);  //Turn off Red
